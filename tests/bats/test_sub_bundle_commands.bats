...
@test "sub bundle creates the default redacted bundle" {
  ...
  [ "$status" -eq 0 ]
  [[ "$output" == *"SUB_BUNDLE=pass output=./vpskit-client-bundle redacted=yes"* ]]
  [[ "$output" == *"SUB_BUNDLE_FILES=23"* ]]
  [[ "$output" == *"SENSITIVE_OUTPUT=redacted"* ]]
  [[ "$output" != *"test-password"* ]]
  [ -d "${BATS_TEST_TMPDIR}/vpskit-client-bundle" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/README.en.md" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/README.zh.md" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/manifest.txt" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/protocol-layout.txt" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/security-notes.en.md" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/security-notes.zh.md" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/import-shadowrocket.en.md" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/import-shadowrocket.zh.md" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/import-v2rayng.en.md" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/import-v2rayng.zh.md" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/import-clash-meta.en.md" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/import-clash-meta.zh.md" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/import-sing-box.en.md" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/import-sing-box.zh.md" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/qa-summary.txt" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/command-checklist.txt" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/subscriptions/vless-reality.txt" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/subscriptions/hysteria2.yaml" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/subscriptions/trojan-redacted.uri" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/subscriptions/clash-meta.yaml" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/subscriptions/sing-box.json" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/troubleshooting/common-issues.en.md" ]
  [ -f "${BATS_TEST_TMPDIR}/vpskit-client-bundle/troubleshooting/common-issues.zh.md" ]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/manifest.txt")" == *"VPSKIT_BUNDLE_VERSION=v0.7.0-beta"* ]]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/manifest.txt")" == *"BUNDLE_MODE=redacted"* ]]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/manifest.txt")" == *"VLESS_REALITY=present"* ]]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/manifest.txt")" == *"HYSTERIA2=present"* ]]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/manifest.txt")" == *"TROJAN=present"* ]]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/manifest.txt")" == *"CLASH_META=present"* ]]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/manifest.txt")" == *"SING_BOX=present"* ]]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/manifest.txt")" == *"SENSITIVE_OUTPUT=redacted"* ]]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/protocol-layout.txt")" == *"TCP 443  -> Xray -> VLESS Reality"* ]]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/protocol-layout.txt")" == *"UDP 443  -> Hysteria2"* ]]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/protocol-layout.txt")" == *"TCP 8443 -> Xray -> Trojan TLS"* ]]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/qa-summary.txt")" == *"VPSKIT_QA=pass"* ]]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/qa-summary.txt")" == *"VPSKIT_QA_VERSION=v0.7.0-beta"* ]]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/subscriptions/trojan-redacted.uri")" == *"REDACTED"* ]]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/subscriptions/trojan-redacted.uri")" != *"test-password"* ]]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/subscriptions/clash-meta.yaml")" == *"proxies:"* ]]
  [[ "$(cat "${BATS_TEST_TMPDIR}/vpskit-client-bundle/subscriptions/sing-box.json")" == *"\"outbounds\""* ]]
  run bash -c 'find "$1" -type f \( -name "server.key" -o -name "*.env" \) | grep -q .' _ "${BATS_TEST_TMPDIR}/vpskit-client-bundle"
  [ "$status" -eq 1 ]
  assert_file_ends_with_single_newline "${BATS_TEST_TMPDIR}/vpskit-client-bundle/manifest.txt"
  assert_file_ends_with_single_newline "${BATS_TEST_TMPDIR}/vpskit-client-bundle/qa-summary.txt"
  assert_file_ends_with_single_newline "${BATS_TEST_TMPDIR}/vpskit-client-bundle/subscriptions/trojan-redacted.uri"
}
