...
This repository has completed **Phase 0.5** and **Phase 1A**, and is starting **Phase 1B**. Phase 0.5 is only a runnable and testable backend/frontend application skeleton.
...
- Later Phase 1 work: guarded preflight decisions and mutation planning after read-only inspection is tested.
...
当前仓库已经完成 **Phase 0.5** 和 **Phase 1A**，并开始 **Phase 1B**。Phase 0.5 只是一个可运行、可测试的后端和前端应用骨架。
...
- 后续 Phase 1 工作：在只读检查完成测试之后，再设计受保护的预检决策和修改计划。
